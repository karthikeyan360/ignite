...
export class SceneVisualizationComponent implements OnChanges, OnDestroy, OnInit {
  ...
  public tryToRender() {
    ...
    if (this.scene && this.scene .visible && this.visualizerWrapperRef) {
      console.log(this.scene);
      const canvas = this.sceneVisualizationComponentService.setScreenDimensions(900,this.visualizerWrapperRef.nativeElement.clientWidth);
